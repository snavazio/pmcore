...
COMPONENT_MAP = {
    ...
    "planner":      (build_pmplanner,      "corpus/master_corpus_v4.jsonl"),
    "reasoner":     (build_pmreasoner,     "corpus/master_corpus_v4.jsonl"),
    "communicator": (build_pmcommunicator,      "corpus/communicator_clean_corpus.jsonl"),
}
